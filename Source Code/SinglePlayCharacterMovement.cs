...
public class SinglePlayCharacterMovement : MonoBehaviour
{
    ...
    private float moveDirectionX = 0f;          // Determines the direction player is moving along x-axis (-1 = left, 0 = idle, 1 = right)
    ...
    private void FixedUpdate()
    {
        ...
        if (!_isDashing)
            _rigidBod.velocity = new Vector2(moveDirectionX * moveSpeed, _rigidBod.velocity.y);
    ...
    private IEnumerator Dash()
    {
        ...
        _rigidBod.velocity = new Vector2(moveDirectionX * dashForce, 0f);           // Player dashes in direction they are currently moving
